...
public:
    ...
    // Get resource type
    virtual ResourceOriginType getOriginType(Resource &sender) const { ResourceOriginType::unknown; }
    ...
    // Notify disconnect
    virtual bool disconnect(bool force) { return false; }
...
public:
    ...
    bool disconnect(bool force) override;
