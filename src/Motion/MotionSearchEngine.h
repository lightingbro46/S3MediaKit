 ...
 */
class MotionSearchEngine {
public:
    using Ptr = std::shared_ptr<MotionSearchEngine>;
     ...
     */
    explicit MotionSearchEngine(const MediaTuple &tuple, const std::string &base_path = "");
    ~MotionSearchEngine() = default;
...
private:
    ...
    MultiMotionDemuxer::Ptr _demuxer;
