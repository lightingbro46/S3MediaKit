...
#define CODEC_MAP(XX) \
    ...
    XX(CodecG711A, TrackAudio, 3, "PCMA", PSI_STREAM_AUDIO_G711A, MOV_OBJECT_G711a, MKV_CODEC_UNKNOWN)     \
    XX(CodecG711U, TrackAudio, 4, "PCMU", PSI_STREAM_AUDIO_G711U, MOV_OBJECT_G711u, MKV_CODEC_UNKNOWN)     \
    XX(CodecOpus,  TrackAudio, 5, "opus", PSI_STREAM_AUDIO_OPUS, MOV_OBJECT_OPUS, MKV_CODEC_AUDIO_OPUS)    \
    XX(CodecL16,   TrackAudio, 6, "L16", PSI_STREAM_RESERVED, MOV_OBJECT_NONE, MKV_CODEC_UNKNOWN)          \
...
/**
 * Get mkv codec id by codecid
 */
int getMkvIdByCodec(CodecId codecId);

/**
 * Get CodecId by mkv codec id
 */
