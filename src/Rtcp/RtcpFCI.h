#ifndef S3MEDIAKIT_RTCPFCI_H
#define S3MEDIAKIT_RTCPFCI_H
...
public:
    ...
    using TwccPacketStatus
        = std::map<uint16_t /*rtp ext seq*/, std::pair<SymbolStatus, int16_t /*recv delta, unit is 250us*/>>;
    void check(size_t size);
