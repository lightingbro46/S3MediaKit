...
void RestartScheduler::emitEvent() {
    auto flag = NOTICE_EMIT(
        BroadcastSystemAuditLogArgs, Broadcast::kBroadcastSystemAuditLog, 
        SystemAuditLogType::RESTART_SCHEDULE, string("Restart due to scheduled task"));
    if (!flag) {
