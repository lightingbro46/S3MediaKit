#ifndef S3MEDIAKIT_WEBRTC_SIGNALING_PEER_H
#define S3MEDIAKIT_WEBRTC_SIGNALING_PEER_H
...
private:
    ...
    std::string _room_id;
    std::unordered_map<std::string /*peer_guest_id*/, std::string /*transport_identifier*/> _peer_guests; //as called
    std::unordered_map<std::string /*peer_room_id*/, std::pair<std::string /*guest_id*/, std::string /*transport_identifier*/>> _tours;  //as caller
