...
#else
    WarnL << "WebRTC feature is not enabled, please enable ENABLE_WEBRTC during compilation";
#endif
}
...
API_EXPORT void API_CALL mk_webrtc_add_room_keeper2(
    ...
    // room_id: registered id, signaling server will check the uniqueness of this id
